...
/**
 * Convert youtube links to video info.  Based on Raindrop code.
 */

var GDATA_API_URL = "http://gdata.youtube.com/feeds/api/videos/%s?v=2&alt=json";
...
chewdex.registerUrlHandlers([
  ...
  chew: function(fetch, emit, url) {
    var hash = (url.domain == "www.youtube.com") ?
                 url.getQueryParam("v") : url.path;
    try {
